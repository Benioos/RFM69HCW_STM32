...
Lightweight C driver for the **RFM69HCW / SX1231** RF transceiver, designed for **STM32** microcontrollers using the **STM32 HAL** library.

This library provides a simple and efficient API for configuring and controlling the radio module over SPI.
...
| Radio Configuration | Use | Example |
| :--- | :---: | :--- |
...
| Modulation & Packet Engine | Use | Example |
| :--- | :---: | :--- |
...
| Automatic Frequency Correction AFC | Use | Example |
| **RFM69_StartAFC** | Start Frequency Recalibration AFC  | Nothing (void) |
| **RFM69_Status_RecalibrationFrequencyAFC** | Get Status of the Automatic Recalibration Frequency Correction AFC  | Nothing (void) |
| **RFM69_GetAFCCorrectionHz** | Read AFC Correction in Hz  | Nothing (void) |

---

| Frequency Error Indicator FEI | Use | Example |
| **RFM69_StartFEI** | Start Measurement Of Error Frequency in Hz FEI  | Nothing (void) |
| **RFM69_Status_ReadingErrorFrequency** | Get Status of the Reading Error Frequency FEI  | Nothing (void) |
| **RFM69_GetFrequencyErrorFeiHz** | Read Error Frequency in Hz FEI | Nothing (void) |
